...
class X11RandrQueryVersionRequest extends X11Request {
  ...
  X11RandrQueryVersionRequest({this.majorVersion = 1, this.minorVersion = 5});
  ...
  @override
  String toString() =>
      'X11RandrQueryVersionRequest(majorVersion: ${majorVersion}, minorVersion: ${minorVersion})';
}
...
X11RandrTransform _readX11RandrTransform(X11ReadBuffer buffer) {
  ...
  return X11RandrTransform(p11, p12, p13, p21, p22, p23, p31, p32, p33);
}

void _writeX11RandrTransform(
    X11WriteBuffer buffer, X11RandrTransform transform) {
...
class X11RandrSetCrtcTransformRequest extends X11Request {
  final int crtc;
  final X11RandrTransform transform;
  ...
  factory X11RandrSetCrtcTransformRequest.fromBuffer(X11ReadBuffer buffer) {
    var crtc = buffer.readUint32();
    var transform = _readX11RandrTransform(buffer);
  ...
  void encode(X11WriteBuffer buffer) {
    ...
    buffer.writeUint32(crtc);
    _writeX11RandrTransform(buffer, transform);
...
class X11RandrGetCrtcTransformReply extends X11Reply {
  ...
  final X11RandrTransform currentTransform;
  final String currentFilterName;
  final List<double> currentFilterParams;
  final X11RandrTransform pendingTransform;
  ...
  X11RandrGetCrtcTransformReply(
      ...
      this.currentTransform =
          const X11RandrTransform(1, 0, 0, 0, 1, 0, 0, 0, 1),
  ...
  static X11RandrGetCrtcTransformReply fromBuffer(X11ReadBuffer buffer) {
    buffer.skip(1);
    var pendingTransform = _readX11RandrTransform(buffer);
    var hasTransforms = buffer.readBool();
    buffer.skip(3);
    var currentTransform = _readX11RandrTransform(buffer);
    buffer.skip(4);
  ...
  void encode(X11WriteBuffer buffer) {
    buffer.skip(1);
    _writeX11RandrTransform(buffer, pendingTransform);
    buffer.writeBool(hasTransforms);
    buffer.skip(3);
    _writeX11RandrTransform(buffer, currentTransform);
    buffer.skip(4);
